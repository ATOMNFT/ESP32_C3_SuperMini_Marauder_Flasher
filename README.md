...
| ---- |
| No serial connection at this time, but I am working on the issue. |
...
* If you're already in chrome click the button to flash the project onto ESP32C3 Super Mini
